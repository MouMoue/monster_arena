...
const HERO_GUNS = (() => {
  ...
  return {
    ...
    flame: make(24, 13, [8, 8], [24, 4], px => {
      px(0, 3, 20, 4, P.o); px(1, 4, 18, 2, P.s);          // 管
      px(18, 2, 6, 6, P.o); px(19, 3, 4, 4, '#e8602a');    // 喷嘴
      px(6, 7, 5, 6, P.o); px(7, 8, 3, 4, P.wd);           // 燃料罐
      px(0, 1, 4, 4, P.o);
    }),
    laser: make(28, 11, [9, 7], [28, 4], px => {
      px(0, 3, 26, 3, P.o); px(1, 4, 24, 1, P.sl);         // 管
      px(24, 2, 4, 5, '#7ad8ff'); px(25, 3, 2, 3, '#cfffff'); // 发射口
      px(2, 1, 8, 3, P.o); px(3, 2, 6, 1, P.a);            // 顶
      px(11, 6, 3, 5, P.o);                                // 握把
    }),
    plasma: make(27, 14, [8, 8], [27, 5], px => {
      px(0, 4, 22, 5, P.o); px(1, 5, 20, 3, P.s);          // 主体
      px(20, 2, 7, 9, P.o); px(21, 3, 5, 7, '#c060e0');    // 能量室
      px(22, 4, 3, 5, '#f0b0ff');
      px(7, 9, 4, 5, P.o); px(8, 10, 2, 3, P.a);           // 握把
    }),
    tesla: make(25, 12, [8, 7], [25, 4], px => {
      px(0, 3, 21, 3, P.o); px(1, 4, 19, 1, P.sl);         // 管
      px(20, 1, 5, 7, P.o); px(21, 2, 3, 5, '#ffe84a');    // 线圈
      px(9, 6, 3, 5, P.o);                                 // 握把
    }),
    railgun: make(34, 12, [11, 7], [34, 5], px => {
      px(0, 4, 32, 3, P.o); px(1, 5, 30, 1, P.s);          // 长管
      px(30, 3, 4, 5, '#a0c0ff'); px(31, 4, 2, 3, '#e0f0ff'); // 炮口
      px(2, 2, 12, 2, P.o); px(3, 2, 10, 1, '#6080ff');    // 轨道
      px(0, 1, 8, 5, P.o); px(1, 2, 6, 3, P.wd);           // 机匣
      px(14, 7, 3, 5, P.o);                                // 握把
    }),
  };
})();
